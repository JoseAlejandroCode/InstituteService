  ...
  public Docket api() {
    return new Docket(DocumentationType.SWAGGER_2)
            ...
            .apis(RequestHandlerSelectors
                    .basePackage("com.microservice.institute.controller"))
            .paths(PathSelectors.regex("/api/institutes.*"))
            .build()
            .genericModelSubstitutes(Mono.class, Flux.class, Optional.class)
            .apiInfo(apiEndPointsInfo());
  }
  private ApiInfo apiEndPointsInfo() {
    return new ApiInfo("Institute Microservice",
            "Institute Management REST API", "1.0", "" ,
